                        ...
                        r(e, [
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    if (a && a.content) {
                                        var r = a.content.match(
                                                /initial\-scale\=\d+(\.\d+)?/
                                            ),
                                            l = r
                                                ? parseFloat(r[0].split('=')[1])
                                                : 1;
                                        1 > l &&
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    v['default'].bind(t, 'touchstart', function(
                                        t
                                    ) {
                                        (e.switchPos.startX =
                                            t.touches[0].pageX),
                                    ...
                                    var o = v['default'].one(
                                        ...
                                        n = !1;
                                    v['default'].bind(o, 'touchstart', function(
                                        e
                                    ) {
                                        var t = o.scrollTop,
                                            i = o.scrollHeight,
        ...
        function(e, t) {
            ...
            function v(e) {
                return 'object' ===
                    ...
                    : e &&
                          'object' ===
                              ('undefined' == typeof e ? 'undefined' : w(e)) &&
                          null !== e &&
                          1 === e.nodeType &&
                        ...
                        c(t, [
                            ...
                            },
                            {
                                ...
                                value: function(e) {
                                    ...
                                    (t += 'try {\n'),
                                        (t +=
                                            'window.__vConsole_cmd_result = (function() {\n'),
                                        (t += 'return ' + e + ';\n'),
                                        (t += '})();\n'),
                                        (t +=
                                            'window.__vConsole_cmd_error = false;\n'),
                                        (t += '} catch (e) {\n'),
                                        (t +=
                                            'window.__vConsole_cmd_result = e.message;\n'),
                                        (t +=
                                            'window.__vConsole_cmd_error = true;\n'),
                                        (t += '}');
                    ...
                    return (
                        ...
                        s(t, [
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    (this.maxLogNumber =
                                        this.vConsole.option.maxLogNumber || x),
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    if (this.isReady)
                                        for (
                                            ;
                                            this.logNumber > this.maxLogNumber;
                                ...
                                value: function(e, t) {
                                    ...
                                    if (((this.reqList[e] = n), this.isReady)) {
                                        ...
                                        n.status >= 400 &&
                                            ...
                                            (this.domList[e] = l);
                                        var s = Object.keys(this.reqList)
                                            .length;
                            ...
                            },
                            {
                                ...
                                value: function(e, t) {
                                    b['default'].addClass(
                                        ...
                                        e.textContent &&
                                            t.appendChild(l(c(e.textContent)));
                                },
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    if (0 == e.length) t.innerHTML = '';
                                        ...
                                        for (var o = 0; o < e.length; o++)
                                            (e[o].name = b.htmlEncode(
                                                e[o].name
                                            )),
                                                (e[o].value = b.htmlEncode(
                                                    e[o].value
                                                ));
