...
export default class UserInfo extends Component {
    ...
    gradeConfirm() {
        ...
        } else if (this.state.grade >= 1 && this.state.grade <= 12) {
            // 校内年龄段
            if (
                this.state.grade < this.curr_year - this.state.born_at - 8 ||
                this.state.grade > this.curr_year - this.state.born_at - 3
            ) {
                return confirm(msg);
            }
        } else {
